...
class Result extends React.PureComponent {
    ...
    render = () => {
        const {
            state: { isOpened, anons, protocols, misc, search, countries, items, countOfResults, inBlacklists, timeout, ports, sorting },
            captureExtraData,
            close,
            save,
            onSearchInput,
        ...
        return (
            <div className={`result-container ${isOpened ? 'opened' : ''}`}>
                <div className="result-content-pre">
                    <div className="result-content">
                        ...
                        <div className="up-panel">
                            <button className="open-countries-button" onClick={setCountriesShow}>
                ...
                <ResultCountries {...countries} hideCountries={hideCountries} activeCount={activeCountries.length} toggle={toggleCountry} />
            </div>
        );
    };
}
