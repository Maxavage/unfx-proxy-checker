...
class Result extends React.PureComponent {
    ...
    render() {
        const { isOpened, anons, protocols, extra, search, countries, items, countOfResults } = this.props.state;
        const {
            close, save, onSearchInput, toggleAnon, toggleProtocol, toggleExtra, toggleCountry, loadMore,
            filteredItems 
        } = this.props;
